const IdAttributePlugin =require("@11ty/eleventy").IdAttributePlugin;
const InputPathToUrlTransformPlugin = require("@11ty/eleventy").InputPathToUrlTransformPlugin;
const HtmlBasePlugin = require("@11ty/eleventy").HtmlBasePlugin;
